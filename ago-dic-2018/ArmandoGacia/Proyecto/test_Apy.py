...
class Test(unittest.TestCase):
    ...
    def test_getUsuario(self):
        ...
        self.assertEqual(self.tw.getUsuario("schiob").user_id, self.usuario.user_id)
        self.assertEqual(self.tw.getUsuario("schiob").handle, self.usuario.handle)
        self.assertEqual(self.tw.getUsuario("schiob").lugar, self.usuario.lugar)
        self.assertEqual(self.tw.getUsuario("schiob").verificado, self.usuario.verificado)
        self.assertEqual(self.tw.getUsuario("schiob").followers, self.usuario.followers)
        self.assertEqual(self.tw.getUsuario("schiob").numtweets, self.usuario.numtweets)
        self.assertEqual(self.tw.getUsuario("schiob").friends, self.usuario.friends)
        self.assertEqual(self.tw.getUsuario("schiob").description, self.usuario.description)
        self.assertEqual(self.tw.getUsuario("schiob").lenguaje, self.usuario.lenguaje)
        self.assertEqual(self.tw.getUsuario("schiob").profile, self.usuario.profile)
        self.assertEqual(self.tw.getUsuario("schiob").Ranking, self.usuario.Ranking)
        self.assertEqual(self.tw.getUsuario("schiob").Categoria, self.usuario.Categoria)
        self.assertEqual(self.tw.getUsuario("schiob").Victorias, self.usuario.Victorias)
        self.assertEqual(self.tw.getUsuario("schiob").Derrotas, self.usuario.Derrotas)
