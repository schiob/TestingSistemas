...
class AverageTest(unittest.TestCase):
	...
	def test_read_file(self):
		...
		for t in tests:
			self.assertEqual(p2.get_Contenido(t["in"]), t["out"])
	...
	def test_read_file_mocks(self, reader_mock):
		...
		for t in tests:
			...
			real_output = p2.get_Contenido(t["in"])
	...
	def test_convert_content(self):
		...
		for t in tests:
			self.assertEqual(p2.convertir_contenido(t["in"]), t["out"])
	...
	def test_parse_converted_content(self):
		...
		for t in tests:
			self.assertEqual(p2.parse_Contenido_C(t["in"]), t["out"])
	...
	def test_get_average(self):
		...
		for t in tests:
			self.assertEqual(p2.get_Promedio(t["in"]), t["out"])
